...
Feature: Create, Verify and Delete the created account
  ...
  Scenario Outline: Registering the new user and delete the created user
    ...
    Examples:
      ...
      | hello | r1h4l51@gmail.com | RegistrationDetail | 1         |
      | Hi    | r1h4l52@gmail.com | RegistrationDetail | 2         |
  ...
  Scenario Outline: Place Order Register while Checkout
    ...
    Examples:
      ...
      | hello | r1h8l01@gmail.com | RegistrationDetail | 1         | Deliver it soon | CardDetails | 1      | Congratulations! Your order has been confirmed! |
      | Hi    | r1h8l02@gmail.com | RegistrationDetail | 2         | deliver it soon | CardDetails | 2      | Congratulations! Your order has been confirmed! |