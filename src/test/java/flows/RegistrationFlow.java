...
public class RegistrationFlow extends BaseSetup {
	...
	public void fillRegistrationForm(String password, String first, String last, String company,
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(WaitTimeConstant.waitTime));
		WebElement radioButton = wait.until(ExpectedConditions.elementToBeClickable(By.id(RegistrationPageConstant.genderrRadioButton)));
		radioButton.click();
